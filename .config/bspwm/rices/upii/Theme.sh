...
# Set bspwm configuration for Upii
set_bspwm_config() {
...
# (Tokyo Night) color scheme for Upii Rice
...
* {
    ...
    img-background: url("~/.config/bspwm/rices/upii/rofi.webp", width);
}
EOF
}
